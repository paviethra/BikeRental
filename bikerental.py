...
class BikeRental:
    ...
    def displaystock(self):
        print("Currently {} bikes are avaliable for rent.".format(self.stock))
        return self.stock
    ...
    def rentBikeOnHourlyBasis(self,n):
        if n<=0:
            ...
            print("Sorry! Currently {} bikes are avaliable for rent".format(self.stock))
        else:
            now = datetime.datetime.now()
            print("You have rented {} a bike(s) on hourly basis today at {} hours.".format(n,now.hour))
            print("You willl be charged $5 for each hour per bike.")
            print("We hope you enjoyed our service.")
